...
The k value is very similar to the "knots" in MARS, representing how many basic function is used to fit the model. 

What could be use the smoothing parameters `λ` and `k`
